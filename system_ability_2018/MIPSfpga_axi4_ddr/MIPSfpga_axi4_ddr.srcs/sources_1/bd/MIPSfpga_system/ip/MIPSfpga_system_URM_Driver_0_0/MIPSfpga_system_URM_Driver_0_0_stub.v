...
module MIPSfpga_system_URM_Driver_0_0(CLK100MHZ, resetn, echo, trig, distance, DangerClose)
/* synthesis syn_black_box black_box_pad_pin="CLK100MHZ,resetn,echo,trig,distance[15:0],DangerClose" */;
  input CLK100MHZ;
  input resetn;
  input echo;
  output trig;
