...
architecture STRUCTURE of MIPSfpga_system_URM_Driver_0_0_URM_Driver is
  ...
  signal \counter[16]_i_10_n_0\ : STD_LOGIC;
  ...
  signal \counter[20]_i_10_n_0\ : STD_LOGIC;
  ...
  signal \counter[24]_i_10_n_0\ : STD_LOGIC;
  ...
  signal \counter[28]_i_9_n_0\ : STD_LOGIC;
  ...
  signal \distance_buf[31]_i_1_n_0\ : STD_LOGIC;
...
\count[0]_i_8__0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter[12]_i_10\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter[16]_i_10\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter[20]_i_10\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter[24]_i_10\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter[28]_i_8\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter[28]_i_9\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter_reg[12]_i_6\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \counter[12]_i_7_n_0\,
      S(2) => \counter[12]_i_8_n_0\,
      S(1) => \counter[12]_i_9_n_0\,
      S(0) => \counter[12]_i_10_n_0\
    );
...
\counter_reg[16]_i_6\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \counter[16]_i_7_n_0\,
      S(2) => \counter[16]_i_8_n_0\,
      S(1) => \counter[16]_i_9_n_0\,
      S(0) => \counter[16]_i_10_n_0\
    );
...
\counter_reg[20]_i_6\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \counter[20]_i_7_n_0\,
      S(2) => \counter[20]_i_8_n_0\,
      S(1) => \counter[20]_i_9_n_0\,
      S(0) => \counter[20]_i_10_n_0\
    );
...
\counter_reg[24]_i_6\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \counter[24]_i_7_n_0\,
      S(2) => \counter[24]_i_8_n_0\,
      S(1) => \counter[24]_i_9_n_0\,
      S(0) => \counter[24]_i_10_n_0\
    );
...
\counter_reg[28]_i_6\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2) => \counter[28]_i_7_n_0\,
      S(1) => \counter[28]_i_8_n_0\,
      S(0) => \counter[28]_i_9_n_0\
    );
...
\distance_buf[31]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\distance_buf_reg[16]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[17]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[18]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[19]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[20]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[21]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[22]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[23]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[24]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[25]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[26]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[27]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[28]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[29]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[30]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\distance_buf_reg[31]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
trig_buf_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0002"
    )
        port map (
...
trig_buf_i_2: unisim.vcomponents.LUT6
    generic map(
...
trig_buf_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
trig_buf_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
trig_buf_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
entity MIPSfpga_system_URM_Driver_0_0 is
  ...
  attribute CORE_GENERATION_INFO of MIPSfpga_system_URM_Driver_0_0 : entity is "MIPSfpga_system_URM_Driver_0_0,URM_Driver,{x_ipProduct=Vivado 2015.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=URM_Driver,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,clk170khz_param=588}";
