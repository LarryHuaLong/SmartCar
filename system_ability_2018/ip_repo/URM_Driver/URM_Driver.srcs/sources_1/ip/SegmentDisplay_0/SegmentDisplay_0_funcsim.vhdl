...
entity SegmentDisplay_0_DigitDisplay is
  port (
    cathodes : out STD_LOGIC_VECTOR ( 6 downto 0 );
    Q : in STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of SegmentDisplay_0_DigitDisplay : entity is "DigitDisplay";
end SegmentDisplay_0_DigitDisplay;

architecture STRUCTURE of SegmentDisplay_0_DigitDisplay is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity SegmentDisplay_0_divider is
  port (
    CLK : out STD_LOGIC;
    CLK100MHZ : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of SegmentDisplay_0_divider : entity is "divider";
end SegmentDisplay_0_divider;

architecture STRUCTURE of SegmentDisplay_0_divider is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity SegmentDisplay_0_SegmentDisplay is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of SegmentDisplay_0_SegmentDisplay : entity is "SegmentDisplay";
end SegmentDisplay_0_SegmentDisplay;

architecture STRUCTURE of SegmentDisplay_0_SegmentDisplay is
...
devider: entity work.SegmentDisplay_0_divider
     port map (
      CLK => clk,
      CLK100MHZ => CLK100MHZ
    );
digitDisplay: entity work.SegmentDisplay_0_DigitDisplay
     port map (
...
entity SegmentDisplay_0 is
  ...
  attribute NotValidForBitStream of SegmentDisplay_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of SegmentDisplay_0 : entity is "SegmentDisplay_0,SegmentDisplay,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of SegmentDisplay_0 : entity is "SegmentDisplay_0,SegmentDisplay,{x_ipProduct=Vivado 2015.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=SegmentDisplay,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,clk10khz_param=50000}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of SegmentDisplay_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of SegmentDisplay_0 : entity is "SegmentDisplay,Vivado 2015.2";
end SegmentDisplay_0;

architecture STRUCTURE of SegmentDisplay_0 is
...
inst: entity work.SegmentDisplay_0_SegmentDisplay
     port map (
      CLK100MHZ => CLK100MHZ,
